    ...
    return (
      <SafeAreaView style={{
        ...
        alignItems:'center'
              ...
              <Text style={{ fontSize: fonts.size.h1, includeFontPadding: false, fontFamily: fonts.type.bold, textAlign: 'center', color: colors.red }}>we are a team from miltary police</Text>
